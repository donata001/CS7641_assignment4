...
public class SimpleGrid {
	...
	public static void main(String[] args) {
		...
		SimpleGrid example = new SimpleGrid();
	...
	public SimpleGrid(){
		...
		gwdg = new GridWorldDomain(3, 3);
		gwdg.setMapToSimpleGrid(); 
		...
		GridWorldDomain.setLocation(initialState, 0, 3, 0);
	...
	public void BFSExample(String outputPath){
		...
		p.evaluateBehavior(initialState, rf, tf).writeToFile(outputPath + "planResult" + "BFSExample", sp);
	...
	public void DFSExample(String outputPath){
		...
		//record the plan results to a file
		p.evaluateBehavior(initialState, rf, tf).writeToFile(outputPath + "planResult" + "DFSExample", sp);
	...
	public void AStarExample(String outputPath){
		...
		//record the plan results to a file
		p.evaluateBehavior(initialState, rf, tf).writeToFile(outputPath + "planResult" + "AStarExample", sp);
	...
	public void ValueIterationExample(String outputPath){
		...
		System.out.println("iteration time: " + df.format(testingTime));
		...
		int numTimeSteps = p.evaluateBehavior(initialState, rf, tf).numTimeSteps();
		double discountedReward = p.evaluateBehavior(initialState, rf, tf).getDiscountedReturn(.99);
	...
	public void QLearningExample(String outputPath){
		...
		LearningAgent agent = new QLearning(domain, rf, tf, 0.4, hashingFactory, 0., 0.9);
		...
		for(int i = 0; i < 100; i++){
			...
			double discountedReward = ea.getDiscountedReturn(0.99);
			System.out.println(discountedReward / ea.numTimeSteps());
		}
